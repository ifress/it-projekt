...
<p> Damit Du dich in unserer Seite orientieren könntest, haben wir für Dich einige Informationen zusammengestellt:</p>
  ...
  <ul>
		...
		<li>Pro Sinlge-Choise Test kann eine Frage nur aus einer richtigen Antwort (insgesamt 3 Varianten)  bestehen. Ist diese richtig, dann gibt es ein Punkt. Ist diese falsch, dann wird keinen Punkt vergeben.  </li>
		<li>Bei der  Testleistung werden nur die richtigen Antworten bewertet. </li>
		<li>Eine positive Leistung ist in diesem Fall daran zu erkennen, dass mehr als die H&auml;lfte der maximal erzielbaren Punktezahl erreicht wird (z. B. 30 Punkte &#8722; 100%, f&uuml;r positive Leistung 55% &#8722;  17 Punkte </li>
	</ul>
